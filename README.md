...
Aaron Greenville ([aaron.greenville\@sydney.edu.au](mailto:aaron.greenville@sydney.edu.au){.email})

## Overview

Our overall aim for the unit is to understand the variation of vegetation and animals of the Chichester State Forest in relation to forestry management — in particular, time since harvest — as well as geology, altitude, topography and other site factors.
...
- Access to the tagging tracking worksheet. See [BIOL3009 bulk upload sheet and tagging progress](https://docs.google.com/spreadsheets/d/16pZj3O4XxI4AVXv3wRbDPvQBViGvBTyxMURWwnEkkPc/edit?usp=sharing)

- See Wildlife Insights [tutorials](https://www.wildlifeinsights.org/get-started)

- See Canvas for more resources and instructions.
...
Hints: - Can use multiple browser tabs to upload photos. - Double check deployment details before hitting upload.
